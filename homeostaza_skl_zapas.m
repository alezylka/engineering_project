...
figure;
plot(t, fat_filtered, 'r', 'LineWidth', 0.5);
xlabel('Czas [min]');
...
figure;
subplot(2, 1, 1);
plot(t, glukagon_to_insulina, 'c', 'LineWidth', 0.5);
xlabel('Czas [min]');
ylabel('E(t)/I(t)');
title('Stosunek Glukagon/Insulina');

subplot(2, 1, 2);
plot(t, insulina_to_glukagon, 'k', 'LineWidth', 0.5);
xlabel('Czas [min]');
ylabel('I(t)/E(t)');
title('Stosunek Insulina/Glukagon');
